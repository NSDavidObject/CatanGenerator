//
//  HeadingForTheFogyShores3PlayersGameDefinition.swift
//  Catan
//
...
struct HeadingForTheFogyShores3PlayersGameDefinition: GameDefinition {
    ...
    static let layout: [[GameBoardPiecePlaceholder]] = [
        [
            .empty, .empty, .waterPort(location: .bottomLeft), .waterPort(location: .bottomRight), .plainWater, .fog, .empty, .empty
        ],
        [
            .port(location: .right), .hexagon, .hexagon, .hexagon, .plainWater, .fog, .empty
        ],
        [
            .port(location: .bottomRight), .hexagon, .hexagon, .hexagon, .hexagon, .plainWater, .plainWater, .empty
        ],
        [
            .hexagon, .hexagon, .hexagon, .hexagon, .waterPort(location: .topLeft), .fog, .plainWater
        ],
        [
            .port(location: .right), .hexagon, .hexagon, .hexagon, .waterPort(location: .left), .plainWater, .fog, .empty
        ],
        [
            .empty, .waterPort(location: .topLeft), .plainWater, .plainWater, .fog, .fog, .empty
        ],
        [
            .empty, .empty, .fog, .fog, .plainWater, .plainWater, .empty, .empty
        ],
    ]
}
